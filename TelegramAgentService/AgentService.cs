...
namespace LessonWebProject.TelegramAgent
{
    public class AgentService
    {
        ...
        {
            Console.WriteLine("В этом месте я буду периодически отсылать пользователю обьявления");
        }

        public async Task TelegramBotInitialization()
        {
            Bot = new TelegramBotClient(_options.BotToken);
            ...
            //Telegram.Bot.Extensions.Polling.BlockingUpdateReceiver
        }
